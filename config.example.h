...
#define LOW_BATTERY_RELEASE_PERCENT 26
#define BATTERY_DISPLAY_HYSTERESIS_PERCENT 5
...
#define VOICE_SAMPLE_RATE 17000
#define VOICE_SILENCE_THRESHOLD 256
#define VOICE_PLAYBACK_VOLUME 255
#define VOICE_PLAYBACK_GAIN 96
